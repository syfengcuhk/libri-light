...
apc_notation_train_set=unlab_6k_full # or unlab_600_subset3600utt
...
common_egs_dir=exp/chain_cgn_lat_label/${train_set}${train_subset}/lat_gen_acwt${lat_generator_acwt}/apc_feats_${apc_notation_train_set}/${apc_notation_config}/dnn1b_bi_epoch2/egs
