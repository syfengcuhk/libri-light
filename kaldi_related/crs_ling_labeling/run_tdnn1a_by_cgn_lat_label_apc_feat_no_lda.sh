...
tdnn_affix=1a_nolda  #affix for TDNN directory, e.g. "a" or "b", in case we change the configuration.
...
input_feat_affix= # or mfcc_hires_ivec, or apc
...
dir=exp/chain${nnet3_affix}_cgn_lat_label/${train_set}${train_subset}/lat_gen_acwt${lat_generator_acwt}/apc_feats_${apc_notation_train_set}/${apc_notation_config}/tdnn${tdnn_affix}_bi_epoch${num_epochs}${input_feat_affix}
...
#common_egs_dir=exp/chain_cgn_lat_label/${train_set}${train_subset}/lat_gen_acwt${lat_generator_acwt}/apc_feats_${apc_notation_train_set}/${apc_notation_config}/tdnn1a_bi_epoch5/egs
common_egs_dir=exp/chain_cgn_lat_label/${train_set}${train_subset}/lat_gen_acwt${lat_generator_acwt}/apc_feats_${apc_notation_train_set}/${apc_notation_config}/tdnn1a_bi_epoch3/egs
...
#  fi 
  ...
  relu-batchnorm-layer name=tdnn1 input=Append(-1,0,1) dim=450 self-repair-scale=1.0e-04
  ...
  relu-batchnorm-layer name=tdnn6 input=Append(-6,-3,0) dim=40
