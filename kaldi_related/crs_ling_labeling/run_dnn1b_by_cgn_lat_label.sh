...
common_egs_dir=exp/chain_cgn_lat_label/${train_set}${train_subset}/lat_gen_acwt${lat_generator_acwt}/dnn1b_bi_epoch2_inputmfcc_hires_only/egs
...
if   [ $stage -le 24 ] && [ $stop_stage -gt 24 ]; then
  ...
  eval_set=$abx_eval_set_appoint
   if [ "$model_name" = "final" ];then
     dir1=$dir/bnf_for_libri_light_by_utt/${eval_set}_npy/
     dir2=$dir/bnf_for_libri_light_by_utt/${eval_set}
   else
     dir1=$dir/bnf_for_libri_light_by_utt_${model_name}/${eval_set}_npy/
     dir2=$dir/bnf_for_libri_light_by_utt_${model_name}/${eval_set}
   fi
