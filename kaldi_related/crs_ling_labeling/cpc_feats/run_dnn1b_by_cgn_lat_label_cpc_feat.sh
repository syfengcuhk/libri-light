...
dir=exp/chain${nnet3_affix}_cgn_lat_label/${train_set}${train_subset}/lat_gen_acwt${lat_generator_acwt}/cpc_feats${cpc_notation_train_set}/dnn${tdnn_affix}_bi_epoch${num_epochs}${input_feat_affix}
