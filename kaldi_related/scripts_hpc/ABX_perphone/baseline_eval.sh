...
srun python ../eval/eval_ABX.py data_by_utt${cmvn_suffix}/${eval_set}_npy/ ../eval_ABX_personal/ABX_src/ABX_data/output_items/${eval_set}_${eval_phone1}_${eval_phone2}.item --file_extension .npy --out $output_dir/result_${eval_phone1}_${eval_phone2} --cuda --max_size_group 250 --max_x_across 5
#conda deactivate
