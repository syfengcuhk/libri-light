...
eval_set=dev-clean
for category in monophthongs; do #consts ; do # ST_FR ST_AF FR_AF FR_AP FR_NA AF_AP AF_NA consts ; do #in monophthongs FR_CE FR_BA CE_BA ; do #consts #ST_NA #diphthongs_ended_Y #monophthongs_close #consts_affricate_fricative # monophthongs or diphthongs or vowels or consts_unvoic or consts_voiced or consts or (manner of articulation) _{affricate,approximant,stop,nasal,fricative,affricate_fricative,affricate_stop}
 #category=vowels # monophthongs or diphthongs or vowels or consts_unvoic or consts_voiced or consts
 #eval_phone1=AO
 #eval_phone2=UW
 articulatory_label_type=backness  #height #articulatory  #articulatory_broad_place #articulatory #voicing
