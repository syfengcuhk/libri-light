...
#output_dir=exp/chain_cgn_lat_label/train_unlab_600/lat_gen_acwt10.0/apc_feats_unlab_600_full/apc_5L100_feat13_mfcc_cm_e100_tshift5_res/dnn1b_bi_epoch4/bnf_for_libri_light_by_utt/eval/per_phone/traverse/$eval_set/ #data_by_utt${cmvn_suffix}/eval_by_ABX/per_phone/traverse/${eval_set}
output_dir=exp/chain_cgn_lat_label/train_unlab_600/lat_gen_acwt10.0/dnn1b_bi_epoch3_inputmfcc_hires_only/bnf_for_libri_light_by_utt/eval/per_phone/traverse/$eval_set/
