...
#SBATCH --gres=gpu:2
#SBATCH --exclude=ewi3
#SBATCH --dependency=afterok:6616153
...
#srun bash crs_ling_labeling/cpc_feats/run_dnn1b_by_cgn_lat_label_cpc_feat.sh --stage 13 --stop-stage 14 --nj-split 40 --train-subset "" # 20 for subset900utt, 30 for 3600,7200,14400, 40 for unlab_600(full)
...
srun bash crs_ling_labeling/cpc_feats/run_dnn1b_by_cgn_lat_label_cpc_feat.sh --nj 1 --stage 18 --stop-stage 19 --train-set train_unlab_600 --train-subset "" --cpc-notation-train-set "" --cpc-notation-config "" --lat-generator-acwt 10.0 --num-jobs-initial 2 --num-jobs-final 2 --num-epochs 3 --train-stage 360 --train-exit-stage 720 --abx_eval-set-appoint dev-other --common-egs-dir "exp/chain_cgn_lat_label/train_unlab_600/lat_gen_acwt10.0/cpc_feats/dnn1b_bi_epoch4/egs/"
...
#srun bash crs_ling_labeling/cpc_feats/run_dnn1b_by_cgn_lat_label_cpc_feat.sh --nj 1 --stage 18 --stop-stage 19 --train-set train_unlab_600 --train-subset "" --cpc-notation-train-set "" --cpc-notation-config "" --lat-generator-acwt 10.0 --num-jobs-initial 2 --num-jobs-final 2 --num-epochs 4 --train-stage 460 --train-exit-stage 820 --abx_eval-set-appoint dev-other --common-egs-dir "exp/chain_cgn_lat_label/train_unlab_600/lat_gen_acwt10.0/cpc_feats/dnn1b_bi_epoch4/egs/"
