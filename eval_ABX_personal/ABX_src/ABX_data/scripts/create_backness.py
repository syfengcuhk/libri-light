...
file_out = open("output_items/backness_label/dev-clean_monophthongs.item",'w')
...
#  file_out.write(this_line.split(" ")[0:3])
  ...
  if this_line.split(" ")[3] in list_const("front"):
    splitted_this_line[3] = "FR" 
  elif this_line.split(" ")[3] in list_const("central"):
    splitted_this_line[3] = "CE" 
  elif this_line.split(" ")[3] in list_const("back"):
    splitted_this_line[3] = "BA"
  else:
