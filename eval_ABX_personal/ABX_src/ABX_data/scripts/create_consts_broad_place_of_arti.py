...
parser.add_argument('type_place', type=str, help='stop, nasal, fricative, affricate, approximant')
...
file_out = open("output_items/dev-clean_consts_" + args.type_place  + ".item",'w')
...
consonants = list_const(args.type_place)
if len(consonants) == 0:
    print('check input place of articulation type.')
    sys.exit()
else:
    print(consonants)
