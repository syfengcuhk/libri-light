...
file_out = open("output_items/articulatory_broad_place_label/dev-clean_consts.item",'w')
...
#      "bilabial": ['P', 'B', 'M', 'W'],
#      "labiodental": ['F', 'V'],
      "CORONAL": ['TH', 'DH', 'T', 'D', 'S', 'Z', 'N', 'L', 'CH', 'JH', 'SH', 'ZH', 'R'],
#      "dental": ['TH', 'DH'],
...
#  file_out.write(this_line.split(" ")[0:3])
  ...
  if this_line.split(" ")[3] in list_const("LABIAL"):
    splitted_this_line[3] = "LAB" 
  elif this_line.split(" ")[3] in list_const("CORONAL"):
    splitted_this_line[3] = "COR" 
  elif this_line.split(" ")[3] in list_const("DORSAL"):
    splitted_this_line[3] = "DOR"
  elif this_line.split(" ")[3] in list_const("LARYNGEAL"):
    splitted_this_line[3] = "LAR"  
