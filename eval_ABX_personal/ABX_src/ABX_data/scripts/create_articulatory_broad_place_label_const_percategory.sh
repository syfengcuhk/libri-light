...
f = open('output_items/articulatory_broad_place_label/dev-clean_consts.item','r')
lines = f.readlines()
# lines[0]: '#file onset offset #phone prev-phone next-phone speaker\n'
# lines[1]: '6295-244435-0009 0.2925 0.4725 IH L NG 6295\n'
file_out = open("output_items/articulatory_broad_place_label/dev-clean_" + args.wanted_category1 + "_" + args.wanted_category2 + ".item",'w')
