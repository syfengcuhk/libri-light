...
parser.add_argument('type_manner', type=str, help='front_central, back, close, open')
...
# below is my version
#def list_vowel(argument):
#    switcher = {
#      "front_central": ['IY', 'EH', 'AE', 'IH', 'ER'],
#      "back": ['UW', 'AO', 'UH', 'AA', 'AH'],
#      "front": ['IY', 'IH', 'EH', 'AE'],
#      "central": ['ER'],
#      "close": ['IY', 'UW', 'IH', 'UH'],
#      "mid_open": ['EH', 'ER', 'AH', 'AO', 'AE', 'AA'],
#      "mid": ['ER', 'EH', 'AH', 'AO'],
#      "open": ['AE','AA']
#   } 
#    return switcher.get(argument, "nothing")

# below is revised by OS
def list_vowel(argument):
    switcher = {
      "front_central": ['IY', 'EH', 'AE', 'IH', 'ER', 'AH', 'AA'],
      "back": ['UW', 'AO', 'UH'],
      "front": ['IY', 'IH', 'EH', 'AE'],
      "central": ['ER', 'AH', 'AA'],
      "close": ['IY', 'UW', 'IH', 'UH'],
    ...
    return switcher.get(argument, "nothing")
vowels = list_vowel(args.type_manner)

# lines[0]: '#file onset offset #phone prev-phone next-phone speaker\n'
# lines[1]: '6295-244435-0009 0.2925 0.4725 IH L NG 6295\n'
#file_out = open("output_items/dev-clean_monophthongs_" + args.type_manner  + ".item"   ,'w')
file_out = open("output_items/dev-clean_monophthongs_revised_OS_" + args.type_manner  + ".item"   ,'w')
file_out.write(lines[0])
for this_line in lines:
#  sys.stdout.write("hello\n")
#  if this_line.split(" ")[3] ==  args.wanted_phone1 or this_line.split(" ")[3] == args.wanted_phone2 :
  if this_line.split(" ")[3] in vowels :
    #print(this_line[:-1])
