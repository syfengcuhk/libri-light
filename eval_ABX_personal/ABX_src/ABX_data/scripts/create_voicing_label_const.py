...
file_out = open("output_items/voicing_label/dev-clean_consts.item",'w')
file_out.write(lines[0])
def list_const(argument):
    switcher = {
      "voiceless": ['CH', 'S', 'TH', 'SH', 'F', 'K', 'T', 'P', 'HH' ],
      "voiced": [ 'JH','Y','W','R','L','Z','ZH','DH','V','M','N','NG','G','D','B' ] 
#      "stop": ['K', 'G', 'P', 'B', 'T', 'D'],
#      "nasal": ['M', 'N', 'NG'],
...
#  file_out.write(this_line.split(" ")[0:3])
  ...
  if this_line.split(" ")[3] in list_const("voiced"):
    splitted_this_line[3] = "VD" 
  elif this_line.split(" ")[3] in list_const("voiceless"):
    splitted_this_line[3] = "VL"
#  elif this_line.split(" ")[3] in list_const("fricative"):
#    splitted_this_line[3] = "FR"  
#  elif this_line.split(" ")[3] in list_const("affricate"):
#    splitted_this_line[3] = "AF"
#  elif this_line.split(" ")[3] in list_const("approximant"):
#    splitted_this_line[3] = "AP"
  else:
    # not a consonant
    continue
