...
parser.add_argument('Diphthong_ended_by', type=str, help='Y,W')
...
vowels = list_diphthongs(args.Diphthong_ended_by)
# lines[0]: '#file onset offset #phone prev-phone next-phone speaker\n'
# lines[1]: '6295-244435-0009 0.2925 0.4725 IH L NG 6295\n'
file_out = open("output_items/dev-clean_diphthongs_ended_"+ args.Diphthong_ended_by + ".item",'w')
