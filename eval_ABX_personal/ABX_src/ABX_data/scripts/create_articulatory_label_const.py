...
file_out = open("output_items/articulatory_label/dev-other_consts.item",'w')
...
#  file_out.write(this_line.split(" ")[0:3])
  ...
  if this_line.split(" ")[3] in list_const("stop"):
    splitted_this_line[3] = "ST" 
  elif this_line.split(" ")[3] in list_const("nasal"):
    splitted_this_line[3] = "NA"
